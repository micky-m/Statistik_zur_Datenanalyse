...
```{r}
# x besteht aus den drei Elementen [1] 1 2 3
1:2 + x
```
...
Lösung: **Listen** Listen fssen Objekte von unterschiedlichem Typ und unterschiedlichem Format zusammen. Super für Funktions-Rückgaben.
...
Ansprechen von Objekten in Listen: **Name**
