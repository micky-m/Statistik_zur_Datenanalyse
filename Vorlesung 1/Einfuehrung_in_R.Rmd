...
Mit Namen (aber auch Index eis[,2]) kann auf einzelne Spalte zugegriffen werden. Wir sehen, die obige Spalte besteht nur aus "char"-Einträgen. Eine effiziente Methode zur Arbeit mit strings ist es, das Datenformat **factor** zu nehmen:
...
R erkennt automatisch schon, wenn sich ein factor anbietet.
